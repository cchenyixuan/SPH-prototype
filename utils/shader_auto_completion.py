...
shader_src_list = [
    ...
    # "sph/Solvers/compute_0_init_boundary_particles.shader",
    # "sph/Solvers/compute_1_init_domain_particles.shader",
    # "sph/Solvers/compute_1_init_inlet_particles.shader",
    # "sph/Solvers/compute_2_boundary_density_pressure_renormalize_solver.shader",
    # "sph/Solvers/compute_2_density_pressure_solver.shader",
    # "sph/Solvers/compute_2_density_derivative_solver.shader",
    # "sph/Solvers/compute_3_force_solver.shader",
    # "sph/Solvers/compute_4_integrate_solver.shader",
    # "sph/Solvers/compute_5_voxel_upgrade_solver.shader",
    # "sph/Solvers/compute_6_combine_solver.shader",
    ...
    # "delta_sph/Solvers/compute_1b_init_boundary_distribution_correction.shader",
    # "delta_sph/Solvers/compute_2_boundary_density_pressure_renormalize_solver.shader",
    # "delta_sph/Solvers/compute_2_boundary_density_shift_solver.shader",
    ...
    "wcsph/Solvers/compute_0_init_boundary_particles.shader",
    "wcsph/Solvers/compute_1_init_domain_particles.shader",
    "wcsph/Solvers/compute_1_init_inlet_particles.shader",
    "wcsph/Solvers/compute_1b_init_boundary_distribution_correction.shader",
    "wcsph/Solvers/compute_2_boundary_density_pressure_solver.shader",
    "wcsph/Solvers/compute_2_density_pressure_solver.shader",
    "wcsph/Solvers/compute_3_force_solver.shader",
    "wcsph/Solvers/compute_4_integrate_solver.shader",
    "wcsph/Solvers/compute_5_voxel_upgrade_solver.shader",
...
const_variables = {
    ...
    "Coeff_Wendland_3d_d": lambda value: f"const float Coeff_Wendland_3d_d = {float(value)};\n",
